...
<div class="mt-6 flex items-center gap-2">
    <a href="#" class="px-3 py-2 rounded-lg border"
       onclick="if (window.parent && typeof window.parent.closeIframeModal === 'function') { window.parent.closeIframeModal(); } else { window.location.href=\"{{ route('vehicles.index') }}\"; } return false;">Cancelar</a>
